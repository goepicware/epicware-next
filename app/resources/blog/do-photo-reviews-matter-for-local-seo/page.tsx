...
const schema = {
  ...
  "url": "https://epicware.ai/resources/blog/do-photo-reviews-matter-for-local-seo"
};
...
export default function Post() {
  return (
    <BlogArticle
      ...
      relatedPosts={[
        { title: "Do Keywords in Google Reviews Help Local SEO?", href: "/resources/blog/do-keywords-in-reviews-help-local-seo" },
