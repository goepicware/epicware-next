...
const posts = [
  ...
  { title: "Review Velocity vs Total Review Count — Which Matters More for Google Maps?", summary: "Whether Google Maps ranking is driven more by review count or review recency.", href: "/resources/blog/review-velocity-vs-total-review-count" },
  { title: "Do Keywords in Google Reviews Help Local SEO?", summary: "Whether keywords in customer reviews affect Google Maps rankings. The nuanced answer.", href: "/resources/blog/do-keywords-in-reviews-help-local-seo" },
  ...
  { title: "Review Gating Explained — What It Is and Why Google Bans It", summary: "Review gating only directs happy customers to Google reviews. It violates Google policy.", href: "/resources/blog/review-gating-explained" },
  ...
  { title: "How Fast Should You Respond to Google Reviews?", summary: "The ideal response time for positive and negative Google reviews.", href: "/resources/blog/how-fast-should-you-respond-to-google-reviews" },
  ...
  { title: "Customer Feedback System — Private vs Public Reviews", summary: "How to design a system that captures private feedback and generates public Google reviews without violating policy.", href: "/resources/blog/customer-feedback-system-private-vs-public-reviews" },
