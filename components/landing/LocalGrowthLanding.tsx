...
function AIWins() {
  const platforms = [
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-5 h-5" fill="#10B981">
          <path d="M22.282 9.821a5.985 5.985 0 0 0-.516-4.91 6.046 6.046 0 0 0-6.51-2.9A6.065 6.065 0 0 0 4.981 4.18a5.985 5.985 0 0 0-3.998 2.9 6.046 6.046 0 0 0 .743 7.097 5.98 5.98 0 0 0 .51 4.911 6.051 6.051 0 0 0 6.515 2.9A5.985 5.985 0 0 0 13.26 24a6.056 6.056 0 0 0 5.772-4.206 5.99 5.99 0 0 0 3.997-2.9 6.056 6.056 0 0 0-.747-7.073zM13.26 22.43a4.476 4.476 0 0 1-2.876-1.04l.141-.081 4.779-2.758a.795.795 0 0 0 .392-.681v-6.737l2.02 1.168a.071.071 0 0 1 .038.052v5.583a4.504 4.504 0 0 1-4.494 4.494zM3.6 18.304a4.47 4.47 0 0 1-.535-3.014l.142.085 4.783 2.759a.771.771 0 0 0 .78 0l5.843-3.369v2.332a.08.08 0 0 1-.032.067L9.608 19.95a4.492 4.492 0 0 1-6.008-1.646zM2.34 7.896a4.485 4.485 0 0 1 2.366-1.973V11.6a.766.766 0 0 0 .388.676l5.815 3.355-2.02 1.168a.076.076 0 0 1-.071 0l-4.83-2.786A4.504 4.504 0 0 1 2.34 7.872zm16.597 3.855l-5.833-3.387L15.119 7.2a.076.076 0 0 1 .071 0l4.83 2.791a4.494 4.494 0 0 1-.676 8.105v-5.678a.79.79 0 0 0-.407-.667zm2.01-3.023l-.141-.085-4.774-2.782a.776.776 0 0 0-.785 0L9.409 9.23V6.897a.066.066 0 0 1 .028-.061l4.83-2.787a4.5 4.5 0 0 1 6.68 4.66zm-12.64 4.135l-2.02-1.164a.08.08 0 0 1-.038-.057V6.075a4.5 4.5 0 0 1 7.375-3.453l-.142.08-4.778 2.758a.795.795 0 0 0-.393.681zm1.097-2.365l2.602-1.5 2.607 1.5v2.999l-2.597 1.5-2.607-1.5z"/>
        </svg>
      ),
      query: "best healthy kebab in singapore",
    ...
    },
    {
      ...
      query: "independent animal hospitals in singapore",
      cite: "Beecroft Animal Hospital cited in Google AI Mode — listed with location, hours, and full clinic details",
  ...
  return (
    <section className="relative overflow-hidden bg-[#06060e] py-20 lg:py-28 border-t border-white/[0.06]">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/3 w-[600px] h-[600px] rounded-full bg-blue-700/10 blur-[160px]" />
        <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] rounded-full bg-emerald-600/8 blur-[130px]" />
      </div>

      <div className="relative z-10 mx-auto max-w-6xl px-6">
        <motion.div {...fadeUp(0)} className="text-center mb-14">
          <p className="text-white/35 text-[11px] font-semibold tracking-widest uppercase mb-4">AI visibility wins</p>
          <h2
            className="font-bold text-white leading-[1.1] tracking-[-0.03em] mx-auto mb-4"
            style={{ fontSize: "clamp(1.7rem, 3vw, 2.4rem)", maxWidth: "680px" }}
          >
            Our clients are being cited across every AI platform.
          </h2>
          <p className="text-white/40 text-[1rem] leading-relaxed max-w-xl mx-auto">
            When someone asks ChatGPT, Gemini, or Google AI for the best option near them — Epicware clients get named. Here's the proof.
          </p>
        </motion.div>

        {/* Platform citation cards */}
          ...
          {platforms.map((p, i) => (
            <motion.div key={p.name} {...fadeUp(0.07 + i * 0.07)}>
              ...
              >
                ...
                {/* Query pill */}
                <div className="flex items-center gap-2 rounded-lg bg-white/[0.04] border border-white/[0.07] px-3 py-2">
                  <svg className="w-3 h-3 text-white/30 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
                ...
                <div className="flex gap-2.5 items-start">
                  ...
                  <p className="text-white/60 text-[0.825rem] leading-relaxed">{p.cite}</p>
                </div>
              </div>
            </motion.div>
          ))}
        ...
        <motion.div {...fadeUp(0.42)} className="flex justify-center mt-10">
          <PrimaryCTA label="Get Your AI Visibility Report — Free →" />
        </motion.div>
      </div>
    </section>
  );
