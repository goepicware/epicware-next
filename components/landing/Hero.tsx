  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-[#0A0F1E]">
      ...
      <Link
        ...
        className="fixed bottom-6 right-6 z-40 group flex items-center gap-3 pl-4 pr-5 py-3.5 rounded-2xl bg-[#25D366] hover:bg-[#20BD5A] text-white shadow-[0_4px_24px_rgba(37,211,102,0.45)] hover:shadow-[0_6px_32px_rgba(37,211,102,0.6)] transition-all duration-200 hover:-translate-y-0.5"
      >
        {/* WhatsApp icon */}
        ...
        <div className="flex flex-col">
          ...
          <span className="text-sm font-bold leading-none">{hero.whatsapp.label}</span>
        </div>
      </Link>
    </section>
  );
