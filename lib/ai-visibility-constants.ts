// Copy + config for /ai-visibility. Marketing edits copy and the four
// TODO-VERIFY placeholders here without touching component/layout code.
...
// Which variant server-renders by default (what crawlers and first paint see).
// Override per-visitor with ?h=b or ?h=c — no redeploy needed. See
// components/ai-visibility/HeroHeadline.tsx.
export const DEFAULT_HEADLINE_VARIANT: keyof typeof HEADLINE_VARIANTS = "default";

// ─── TODO-VERIFY placeholders — flagged back per the build spec, not guessed ──
// Rendered via the <Verify> component (yellow highlight) until filled in.

export const TODO_AUDIT_COUNT: string | null = null; // e.g. "500+" — real audited-businesses count
export const TODO_AGENCY_PRICE_LOW: string | null = null; // e.g. "500" — proposed S$500, unconfirmed
export const TODO_AGENCY_PRICE_HIGH: string | null = null; // e.g. "1,500" — proposed S$1,500, unconfirmed
export const TODO_GUARANTEE_TEXT: string | null = null; // exact legally-safe 90-Day Top-3 Guarantee wording

// Section 9 (Proof) stays hidden until a real client stat is supplied.
...
export const AI_VISIBILITY = {
  hero: {
    ...
    microCopy: "Free · 60 seconds · No credit card",
  },
  trustStrip: {
  ...
  howItWorks: {
    steps: [
      { num: "1", body: "Tell us your business and 3 keywords — 60 seconds, 4 short steps." },
